...
#tem muita coisa para essa parte já escrita no Office

Learning patterns... https://trello.com/c/t9SxjmTz/253-encontrar-dados-sobre-learning-patterns-utilizados

Roteiro....ver https://trello.com/c/dH13LfQh/466-detalhar-a-cria%C3%A7%C3%A3o-do-meu-roteiro-da-organiza%C3%A7%C3%A3o-de-uma-editatona

Criação de pré-definições... ver https://trello.com/c/Mp3HXAPg/187-documentar-trabalho-feito-criando-pr%C3%A9-defini%C3%A7%C3%B5es
...
# versar sobre learning patterns criados pela comunidade que foram lidos para a confecção do roteiro.
...
# Citar explicitamente os learning patterns utilizados para criar nosso roteiro.

## Tenho isso mapeado em algum lugar, não sei se no drive ou no trello.

Seguindo a trilha dos learning patterns estudados, criamos predefinições para facilitar a utilização das páginas de testes pelos participantes das editatonas. Estas predefinições permitiram com facilidade a criação e listagens de novas subpáginas de testes, tarefa nada trivial para um usuário não habituado ao funcionamento do MediaWiki.

Imagem: Página de testes criada utilizando a predefinição desenvolvida pela pesquisa.

A predefinição se chama "Predefinição:Página de testes do usuário", e atualmente é utilizada por XX usuários da Wikipédia em português.

# criar seção para falar da única editatona presencial.

Legenda: Editatona presencial com turma de graduação no dia 21 de novembro de 2019.


\subsubsection{No meio do caminho tinha uma pandemia}

Com a revisão dos learning patterns feita e nosso roteiro pronto para se confrontar com o mundo real, partimos para a realização das editatonas. Porém, após somente termos realizado uma edição presencial, o mundo foi surpreendido pela pandemia de COVID-19, que se apresentou acompanhada de medidas de isolamento social que inviabilizaram a realização de mais atividades presenciais conforme planejado.
...
Cogitamos então criar várias salas virtuais, dividir os participantes em grupos e pedir para que cada um se dirigisse a um link diferente após uma abertura realizada em uma única sala. Porém, não estávamos confortáveis com esta solução. A necessidade de abrir uma nova conexão durante a atividade parecia algo um tanto quanto desmobilizante, e que criaria uma segregação entre os grupos impedindo uma série de dinâmicas interessantes observadas em editatonas presenciais.
...
Ademais, em editatonas presenciais não são incomuns momentos em que o wikipedista experiente, a partir da dúvida de um grupo específico, compartilha com todos os presentes alguma situação que o grupo tenha vivido, explicando a questão e dando dicas sobre como prosseguir. 
...
Imagem: Estrutura das salas criadas no servidor “Editatona na Wikipédia” no Disord.
...
    Imagem: Página de organização de uma das editatonas organizadas durante a pesquisa.
    
...
Imagem: exemplo de um pad utilizando por um grupo durante uma editatona virtual.

Os membros de cada grupo então são convidados a seguir o seguinte método: escrever no pad o rascunho do texto que irá para a Wikipédia e compartilhar no chat de texto links que possam ser utilizados como referências e demais conteúdos relacionados ao processo de escrita do grupo. Desta forma, além do trabalho do grupo ficar estruturado, participantes de demais grupos poderão acompanhar com facilidade o que estiver acontecendo nos demais grupos, colaborando e até mudando de grupo com facilidade se desejarem.

Imagem: chat em texto de um grupo das editatonas virtuais, onde podem ser vistos o link para o pad sendo compartilhado e posteriormente um participante pedindo a presença do wikipedista experiente.

Com esta nova metodologia, percebemos que os templates criados para auxiliar na gestão das páginas de testes deixaram de ser tão úteis para a editatona. Enquanto com os editores juntos presencialmente na mesma máquina eles se mostravam um excelente caminho para a criação de rascunhos e familiarização com o MediaWiki, a dinâmica a distância inviabilizou sua utilização na prática.
...
# Narrar impressões gerais e barreiras encontradas. Escolher uns dois casos e narrar densamente a interação entre novato, software, administrador e regras.
...
# Apresentar quantos conteúdos de nossos editathons ficaram no ar após X tempo.
